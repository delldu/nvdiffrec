...
class DatasetMesh(Dataset):
    ...
    def __init__(self, ref_mesh, glctx, cam_radius, FLAGS, validate=False):
        ...
        if 'normal' in ref_mesh.material: # False ?
            pdb.set_trace()
        ...
        self.envlight = light.load_env(FLAGS.envmap, scale=FLAGS.env_scale) # EnvironmentLight()
        self.ref_mesh = mesh.compute_tangents(ref_mesh) # <render.mesh.Mesh object at 0x7f6e9766efa0>

    def _rotate_scene(self, itr):
        # self.FLAGS.display_res -- [512, 512]
